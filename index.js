...
/******/ 	return __webpack_require__(__webpack_require__.s = "./example/index.jsx");
/******/ })
/************************************************************************/
/******/ ({
...
function App() {
  ...
  var _useAxios = Object(_src__WEBPACK_IMPORTED_MODULE_1__["default"])({
    url: "https://randomuser.me/api/".concat(gender === 'unknown' ? 'unknown' : ''),
    method: 'GET',
    options: {
      params: {
        gender: gender
    ...
    // or
    // trigger: { gender }
    forceDispatchEffect: function forceDispatchEffect() {
      return !!gender;
    } // AUTO RUN only if gender is set

  }),
      response = _useAxios.response,
      loading = _useAxios.loading,
      error = _useAxios.error,
      reFetch = _useAxios.reFetch;
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "DEMO of", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
    style: {
      color: '#F44336'
    }
  }, "@use-hooks/axios")), options.map(function (item) {
    ...
    type: "button",
    onClick: reFetch
  }, "Refresh"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, error ? error.message || 'error' : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("textarea", {
    cols: "100",
    rows: "30",
...
/* harmony import */ var _App__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./App */ "./example/App.jsx");
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: default, axios */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CancelToken = axios__WEBPACK_IMPORTED_MODULE_1__["CancelToken"];
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$axios = _ref.axios,
      axios = _ref$axios === void 0 ? axios__WEBPACK_IMPORTED_MODULE_1__ : _ref$axios,
      url = _ref.url,
      ...
      filter = _ref.filter,
      forceDispatchEffect = _ref.forceDispatchEffect,
      customHandler = _ref.customHandler;

  var _useReducer = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])(_reducers__WEBPACK_IMPORTED_MODULE_2__["responseReducer"], _reducers__WEBPACK_IMPORTED_MODULE_2__["initialResponse"]),
      _useReducer2 = _slicedToArray(_useReducer, 2),
      results = _useReducer2[0],
  ...
  var dispatchEffect = forceDispatchEffect || filter || function () {
    return true;
  };

  var handler = function handler(error, response) {
    if (customHandler) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    if (!url || !dispatchEffect()) return; // ONLY trigger by query

    if (typeof outerTrigger === 'undefined' && !innerTrigger) return;
    handler(null, null);
    dispatch({
      type: _reducers__WEBPACK_IMPORTED_MODULE_2__["actions"].init
    });
    ...
    axios(_objectSpread({
      ...
      dispatch({
        type: _reducers__WEBPACK_IMPORTED_MODULE_2__["actions"].success,
        payload: response
      });
    })["catch"](function (error) {
      handler(error, null);

      if (!axios__WEBPACK_IMPORTED_MODULE_1__["isCancel"](error)) {
        dispatch({
          type: _reducers__WEBPACK_IMPORTED_MODULE_2__["actions"].fail,
          payload: error
        });
      }
    });
...
var axios = axios__WEBPACK_IMPORTED_MODULE_1__;
...
/*!*************************!*\
  !*** ./src/reducers.js ***!
  \*************************/
/*! exports provided: initialResponse, actions, responseReducer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initialResponse", function() { return initialResponse; });
